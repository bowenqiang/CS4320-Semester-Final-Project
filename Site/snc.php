...
//            print "Error: $message (code = $code) <br>\n";
        ...
        echo "<script type='text/javascript'>alert('Files successfully contributed!')</script>";
        echo "<script type='text/javascript'>window.location = 'snc.php'</script>";
    }
    ...
    <div class="white z-depth-1 container" style='padding: 1% 1% 1% 1%;'>
      ...
      <div class="row">
		  <div class="input-field col s12">
		  	<h5>Scripts Associated with this Manifest:</h5>
...
<h5>Configs Associated with this Manifest:</h5>
...
//                print "Error: could not open directory.";
        ...
        ?>
              ...
              <h5>Would you like to contribute to this manifest?</h5>
      <form method="post" action="snc.php" enctype="multipart/form-data">
...
<!--                        <form action="#">-->
                <div class="input-field col s12">
                    <div class="file-field input-field">
                        <div class="btn">
                            <span>Choose Config</span>
                            <input type="file" name="file2">
                        </div>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text" placeholder="Upload a Config">
                        </div>
                    </div>
                </div>
<!--                        </form>-->
